...
class OrderInfo(BaseModel):
    ...
    user = models.ForeignKey('apps.user.User', verbose_name='用户')
    addr = models.ForeignKey('apps.user.Address', verbose_name='地址')
...
class OrderGoods(BaseModel):
    ...
    sku = models.ForeignKey('apps.goods.GoodsSKU', verbose_name='商品SKU')
